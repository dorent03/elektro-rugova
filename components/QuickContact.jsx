...
export default function QuickContact() {
  return (
    <div className="fixed bottom-8 left-8 z-50 flex flex-col gap-3">
      {/* Telefon Button */}
      <motion.a
        href="tel:01729411024"
        initial={{ scale: 0 }}
        animate={{ scale: 1 }}
        whileHover={{ scale: 1.1 }}
        whileTap={{ scale: 0.95 }}
        className="bg-green-500 text-white p-4 rounded-full shadow-2xl hover:shadow-3xl transition-all duration-300 flex items-center justify-center"
        aria-label="Anrufen: 0172 9411024"
      >
